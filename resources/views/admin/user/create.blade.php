                ...
                <div id="base-style" class="card">
                  <!-- .card-body -->
                    ...
                    @csrf
                        ...
                        @endif
                         ...
                         <div class="col-md-6 mb-3">
                          ...
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="tf3" name="photo"> <label class="custom-file-label" for="tf3">Choose photo</label>
                          </div>
                        </div><!-- /.form-group -->
                      ...
                      <div class="card-body"><a href="{{asset('user')}}"><button class="btn btn-success "  style="float:right;">back</button></a> 
