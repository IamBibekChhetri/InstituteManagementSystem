                    ...
                    <form action="{{route('fee.update',$fee->id)}}" method="POST">
                      ...
                      <fieldset>
                        ...
                        <div class="form-group">                            
                            ...
                            <label class="switcher-control switcher-control-lg"><input type="checkbox" class="switcher-input" name="status" value="{{$fee->status}}" checked> <span class="switcher-indicator"></span> <span class="switcher-label-on">ON</span> <span class="switcher-label-off">OFF</span></label>                            
                        </div><!-- /.form-group -->
                      </fieldset><!-- /.fieldset -->
