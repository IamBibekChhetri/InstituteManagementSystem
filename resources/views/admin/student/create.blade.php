...
<div class="page-section">
                ...
                <div class="row page-section">
                    ...
                    <div class="form-group">
                          ...
                          <abbr title="Required">*</abbr>
                          <input type="text" class="form-control" id="tfDefault" placeholder="Enter Father Name" name="fatherName">
                        </div><!-- /.form-group -->
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                       <h3>Mother Information</h3>
                         ...
                         <div class="form-group">
                          ...
                          <abbr title="Required">*</abbr>
                          <input type="text" class="form-control" id="tfDefault" name="motherName" placeholder="Enter Mother Name">
                        </div><!-- /.form-group -->
