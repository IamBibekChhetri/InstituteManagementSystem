...
<div class="page-section">
            ...
            <div class="card card-fluid">
                  <!-- .card-header -->
                  <div class="card-header"> Manage User Role <a href="{{asset('user_role/create')}}"><button type="button" class="btn btn-success btn-floated"><span class="fa fa-plus"></span></button></a></div><!-- /.card-header -->
                  <!-- .card-body -->
                  <div class="card-body">
                    <!-- .table -->
