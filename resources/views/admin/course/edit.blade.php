                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <div class="custom-number">
                            <input type="number" class="form-control" id="tf2" name="code" value="{{$course->code}}">
                          </div>
                        </div><!-- /.form-group -->
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <input type="text" class="form-control" id="tfDefault" name="name" value="{{$course->name}}">
                        </div><!-- /.form-group -->

                        <!-- .form-group -->
                        <div class="col-md-6 mb-3">
                          <label for="tf6">Course Deatails</label>
                          <textarea class="form-control" id="tf6" rows="2" name="details">{{$course->details}}</textarea>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        ...
                        <div class="col-md-12 mb-3">                            
                            ...
                            <label class="switcher-control switcher-control-lg">
                              <input type="checkbox" class="switcher-input" name="status" value="{{$course->status}}" checked> <span class="switcher-indicator"></span> <span class="switcher-label-on">ON</span> <span class="switcher-label-off">OFF</span>
                            </label>
                          </div><!-- /.form-group -->
                      </div><!-- /.fieldset -->
